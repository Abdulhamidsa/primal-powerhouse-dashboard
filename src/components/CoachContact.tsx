          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center">
                <EnvelopeSimpleIcon className="w-6 h-6 text-blue-400" aria-hidden="true" focusable="false" />
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center">
                  <PhoneIcon className="w-6 h-6 text-purple-400" aria-hidden="true" focusable="false" />
                </div>
                <div className="flex-1 text-left">
        ...
        <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-amber-500/20 rounded-xl flex items-center justify-center">
              <ClockIcon className="w-5 h-5 text-amber-400" aria-hidden="true" focusable="false" />
            </div>
            <div>
