      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              {[
                ...
                <label
                  ...
                  style={{
                    ...
                    borderColor: formData.activityLevel === level.value ? 'var(--color-accent)' : 'var(--color-border)',
                  }}
                >
                  <input
                    type="radio"
          ...
          <div>
            ...
            {errors.goals && (
              <p style={{ color: 'var(--color-accent)', fontSize: '0.875rem', marginTop: '0.25rem' }}>{errors.goals}</p>
            )}
          </div>
