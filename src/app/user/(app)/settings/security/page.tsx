    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto w-full max-w-md space-y-6 px-4 pb-32 pt-5">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">Manage password access without changing your Google sign-in.</p>
        </div>
        ...
        <section className="overflow-hidden rounded-3xl border border-border bg-card">
          ...
          <div className="border-t border-border/60 px-4 py-4">
            ...
            {passwordLinkResult?.message ? <p className="mt-3 text-xs text-emerald-600">{passwordLinkResult.message}</p> : null}
