...
export default function ClientMealPlansPage() {
  ...
  const [isPersonalizeMealModalOpen, setIsPersonalizeMealModalOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <thead>
                      <tr className="bg-gray-50">
                        ...
                        {mealTypes.map(mealType => (
                          <th
                            key={mealType.value}
                            className="p-4 text-center font-medium text-gray-700 border-b border-gray-200 min-w-[250px]"
                          >
                                  ...
                                  <div className="bg-gray-50 rounded-lg p-3">
                                    ...
                                    {assignment.meal.tags &&
                                      (() => {
                                        try {
                                          const tags =
                                            typeof assignment.meal.tags === 'string'
                                              ? JSON.parse(assignment.meal.tags)
                                              : assignment.meal.tags;
                                          return (
                                            Array.isArray(tags) &&
                                            tags.length > 0 && (
        ...
        {/* Assign Personalized Meals Button */}
        <div className="my-6 text-right">
          <button
            onClick={() => setIsPersonalizeMealModalOpen(true)}
            className="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded"
          >
            Personalize & Assign Meals
          </button>
        </div>

        {/* Personalized Meals Modal */}
