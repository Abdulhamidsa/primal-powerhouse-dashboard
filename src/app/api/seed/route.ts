    ...
    const meals = await Promise.all([
      prisma.meal.create({
        data: {
          ...
          fat: 24,
          fiber: 12,
          ingredients: JSON.stringify(["2 slices whole grain bread", "1 ripe avocado", "2 organic eggs", "1 tsp extra virgin olive oil", "Sea salt and black pepper", "Red pepper flakes", "Fresh herbs (optional)"]),
      ...
      prisma.meal.create({
        data: {
          ...
          fat: 22,
          fiber: 6,
          ingredients: JSON.stringify(["6 oz chicken breast", "4 cups romaine lettuce", "2 tbsp Caesar dressing", "2 tbsp parmesan cheese", "1/4 cup whole grain croutons", "Fresh black pepper"]),
          instructions: JSON.stringify([
      ...
      prisma.meal.create({
        data: {
          ...
          fat: 18,
          fiber: 8,
          ingredients: JSON.stringify(["6 oz wild salmon fillet", "1/2 cup quinoa", "1 cup mixed vegetables (broccoli, carrots, bell peppers)", "1 tbsp olive oil", "Fresh herbs (dill, parsley)", "Lemon juice", "Garlic powder"]),
          instructions: JSON.stringify([
