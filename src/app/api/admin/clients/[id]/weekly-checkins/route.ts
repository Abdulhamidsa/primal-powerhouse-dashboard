    ...
    return jsonWithCache({
      ...
      checkIns: checkIns.map(checkIn => {
        ...
        return {
          ...
          progressPhotoFrontUrl: checkIn.progressPhotoFrontUrl ?? null,
          progressPhotoSideUrl: checkIn.progressPhotoSideUrl ?? null,
          progressPhotoBackUrl: checkIn.progressPhotoBackUrl ?? null,
          strengthUpdate,
          blockerText,
          notes,
        };
